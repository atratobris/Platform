class AlexaResponseService
  ...
  def intent_story_response
    ...
    Paul has arrived home from work and wants to get up to date with the recent news articles using the devices he has set up. He sits down at his table and has a look at the mini LCD screen. He starts swiping in front of the motion sensor in order to go through some articles. As he 
